import { ACCEPTED_IMAGE_TYPES, COVER_IMAGE_MAX_MB } from '@umberleaf/shared';
 ...
 * `@umberleaf/shared` error CODE (→ `messageFor`) or null when acceptable.
 */
// Cap comes from the shared source-of-truth (@umberleaf/shared) so client + server agree — never
