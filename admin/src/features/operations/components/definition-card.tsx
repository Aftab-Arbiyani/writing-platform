 ...
 * list). Used across the Operations views to present grouped read-only fields (build identity,
 * logging posture, current deployment). Presentational only; values are pre-formatted by the caller.
 * Two columns on wider viewports, collapsing to one on mobile — logical grid, no physical margins
 * (mirrors the Security / System slices' `DefinitionCard`).
 */
