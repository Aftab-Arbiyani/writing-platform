 ...
 * list). Used across the Security / Compliance / Privacy views to present grouped read-only fields
 * (consent purposes, DSR explainer, policy overviews). Presentational only; values are
 * pre-formatted by the caller. Two columns on wider viewports, collapsing to one on mobile —
 * logical grid, no physical margins (mirrors the System slice's `DefinitionCard`).
 */
