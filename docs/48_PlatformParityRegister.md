...
> **D4 is no longer in this table** — answered 2026-08-21, backend + mobile built 2026-08-24. What it
> left open is above, with anchors: **D4-web** ([3.22a](#322a-product-defects--a-user-or-an-operator-can-hit-these)),
