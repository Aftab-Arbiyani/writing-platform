...
| **Onboarding**          | a product shape for web (§2 row 7, §5). **Absence re-verified 2026-08-31:** no `frontend/src/features/onboarding`, and the only `onboarding` mention anywhere in `frontend/src` is prose in `register-page.tsx`                                                                                                                                                                                                                                                                                                                                                   | 2026-08-31                |
| **Offline write queue** | a deliberate decision on §2 row 9 rather than closure by omission (§4). **Absence re-verified 2026-08-31:** `frontend/public/sw.js:4` states it outright — _"This file is NOT registered by default. The app ships no offline synchronization"_                                                                                                                                                                                                                                                                                                                   | 2026-08-31                |
