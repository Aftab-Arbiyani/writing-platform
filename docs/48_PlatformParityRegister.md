...
| ------ | ------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **CI** | verification | `web-e2e.yml` needs three green runs, then the flip to `pull_request`. ⚠️ **This row was never 0.5 d away — until 2026-08-24 it was blocked outright** (§3.24): both jobs run `pnpm --filter frontend build`, and that build had been RED since 2026-08-20. The build is fixed; ~~what now stands between here and the flip is **RS-flake**, because "three CONSECUTIVE green runs" cannot survive an intermittent failure~~ **RS-flake closed 2026-08-25 (twelfth reconciliation), so nothing in this ledger blocks the flip any more** — both of its symptoms were deterministic causes, not intermittency, and both are fixed | [e2e/07 §6.1](./e2e/07_CI.md); the build steps are `.github/workflows/web-e2e.yml:157` and `:326` | **0.5 d — and what remains is COUNTING, not building** (2026-08-31: `web-e2e-visual` is now `continue-on-error` and @visual runs with `--retries=0`, so a run is green when the FUNCTIONAL jobs are. Functional greens so far: #24 ✓, #25 ✗ (webkit a11y, fixed §3.25e), #26 ✓ — **not yet three CONSECUTIVE**, so `pull_request` is deliberately NOT added yet. The flip is minutes once the count is there; §3.25f owns the visual work that must precede removing the advisory flag) (the flip itself is minutes; the three green runs are the cost, and one red resets the count) **⚠️ SUPERSEDED 2026-08-31 — see [§3.25g](#325h-runs-28-to-30-the-matrix-narrowed-to-four-jobs-and-the-count-reset-2026-08-31). The count is `#28 ✓ · #29 ✓ · #30 ✗` → back to ZERO**, and #30's red is most likely self-inflicted by `7090050` rather than a suite defect. ~~The criterion itself now needs restating before it can be counted again, because `11f5efb` narrowed a push run from 7 jobs to 4 — **an OWNER DECISION, recorded unanswered**~~ **ANSWERED 2026-09-02 — the criterion is now written at its source, [e2e/07 §6.2](./e2e/07_CI.md): three consecutive PUSH runs in which all four `web-e2e` jobs conclude `success`, counted from the first run after `41b2b49`, with `web-e2e-visual` explicitly NOT counted (it is dispatch-only + advisory, and `WK-visual`'s stale baseline means it could not go green anyway). The answer also repaired a latent defect it was not looking for: §6.1's promotion step required `web-e2e-visual` green ×3, so as written the criterion was UNREACHABLE. Tally: `#30 ✗ (webkit — a job the gate no longer runs) · #31 cancelled (my dispatch killed it) · #32 ✓ · #33 ✓` → **2 of 3** (2026-09-02; #33 = `33607209152`, push, all four jobs green in 7.0 min, and `web-e2e-visual` reported **`skipped`** — measured proof that the old criterion was unreachable, not merely awkward). **ONE green push remains** |
