 ...
 *
 * `@umberleaf/*` packages ship ESM-only dist; Jest's CommonJS runtime can't require
...
const config: Config = {
  ...
  moduleNameMapper: {
    ...
    '^@/(.*)$': '<rootDir>/src/$1',
    '^@umberleaf/shared$': '<rootDir>/../packages/shared/src/index.ts',
    '^@umberleaf/utils$': '<rootDir>/../packages/utils/src/index.ts',
